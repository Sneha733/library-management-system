class LibrariesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @library.save
        format.html { redirect_to library_url(@library), notice: "Book was successfully created." }
  ...
  def update
    respond_to do |format|
      if @library.update(library_params)
        format.html { redirect_to library_url(@library), notice: "Book was successfully updated." }
  ...
  private
    ...
    def library_params
      params.require(:library).permit(:book_name, :Author_name, :brief_description,:extended_description)
    end
end
